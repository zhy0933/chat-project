...
void HttpMgr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (HttpMgr::*_t)(ReqId , QString , ErrorCodes , Modules );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpMgr::sig_http_finish)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (HttpMgr::*_t)(ReqId , QString , ErrorCodes );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HttpMgr::sig_reg_mod_finish)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject HttpMgr::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HttpMgr.data,
      qt_meta_data_HttpMgr,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HttpMgr::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HttpMgr.stringdata0))
        return static_cast<void*>(const_cast< HttpMgr*>(this));
    if (!strcmp(_clname, "Singleton<HttpMgr>"))
        return static_cast< Singleton<HttpMgr>*>(const_cast< HttpMgr*>(this));
    if (!strcmp(_clname, "std::enable_shared_from_this<HttpMgr>"))
        return static_cast< std::enable_shared_from_this<HttpMgr>*>(const_cast< HttpMgr*>(this));
